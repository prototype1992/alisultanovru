                    ...
                    <div className="nav-wrapper main-nav-wrapper">
                        ...
                        <div className="hello_main_navigation hello_single_index_menu2">
                            <ul id="nav-mobile" className="right main-nav-ul">
                                <li className="active"><a href="#" className="nav-mobile">Главная</a></li>
                                <li><a href="#" className="waves-effect default">Обо мне</a></li>
                                <li><a href="#" className="waves-effect default">Навыки</a></li>
                                <li><a href="#" className="waves-effect default">Образование</a></li>
                                <li><a href="#" className="waves-effect default">Портфолио</a></li>
                                <li><a href="#" className="waves-effect default">Отзывы</a></li>
                                <li><a href="#" className="waves-effect default">Опыт работы</a></li>
                                <li><a href="#" className="waves-effect default">Блог</a></li>
                                <li><a href="#" className="waves-effect default">Контакты</a></li>
                                {/*<li>*/}
